(function(){
  ...
  var faq=[{"keys": ["beng", "indicator"], "ans": "<strong>BENG</strong>: Bijna Energie Neutraal Gebouw.<br>&#8226; BENG 1: Energiebehoefte<br>&#8226; BENG 2: Primair fossiel energiegebruik<br>&#8226; BENG 3: Hernieuwbare energie", "chips": ["BENG Checker"]}, {"keys": ["akoestiek", "geluid", "isolatie", "rw"], "ans": "Feniks is gespecialiseerd in akoestisch advies. De <strong>Excel Assistent</strong> vult ontbrekende Rw-waarden in via NEN-EN 12354.", "chips": ["Excel Assistent", "Rapport Schrijver"]}, {"keys": ["bim", "revit", "model"], "ans": "<strong>BIM-modellering</strong> is een kernactiviteit van Feniks. De Kennisbank bevat referentieprojecten met BIM-ervaringen.", "chips": ["Kennisbank"]}, {"keys": ["wkb", "kwaliteitsborg", "directievoer"], "ans": "De <strong>WKB</strong> verhoogt documentatieverplichtingen bij directievoering. De Rapport Schrijver genereert automatisch directievoeringsverslagen.", "chips": ["Rapport Schrijver"]}, {"keys": ["rapport", "rapportage"], "ans": "De <strong>Rapport Schrijver</strong> stelt akoestische rapporten, BIM-kwaliteitschecks en directievoeringsverslagen op.", "chips": ["Rapport Schrijver"]}, {"keys": ["excel", "berekening"], "ans": "De <strong>Excel Assistent</strong> herkent ontbrekende waarden en vult ze in via NEN-standaarden.", "chips": ["Excel Assistent"]}, {"keys": ["norm", "nen", "bbl"], "ans": "De <strong>Norm Monitor</strong> houdt wijzigingen in geluidsnormen, Bbl en bouwfysica-eisen bij.", "chips": ["Norm Monitor"]}, {"keys": ["kennis", "archief", "zoek"], "ans": "Uw <strong>350+ projecten</strong> zijn doorzoekbaar op constructietype, locatie en techniek.", "chips": ["Kennisbank"]}];
  var welcome="Goedemiddag! Ik ben de assistent van Feniks. Waarmee kan ik u helpen?";
