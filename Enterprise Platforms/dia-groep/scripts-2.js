(function(){
  ...
  var faq=[{"keys": ["beng", "indicator"], "ans": "<strong>BENG</strong>: Bijna Energie Neutraal Gebouw.<br>&#8226; BENG 1: Energiebehoefte<br>&#8226; BENG 2: Primair fossiel energiegebruik<br>&#8226; BENG 3: Hernieuwbare energie", "chips": ["BENG Checker"]}, {"keys": ["exploitatie", "beheer"], "ans": "<strong>Exploitatieadvies</strong> is een specialiteit van DIA Groep: optimaliseren van gebouwbeheer en energieverbruik.", "chips": ["Rapport Schrijver"]}, {"keys": ["wkb", "kwaliteitsborg"], "ans": "De <strong>WKB</strong> verhoogt documentatieverplichtingen per project. Het platform genereert WKB-conforme rapportage automatisch.", "chips": ["Rapport Schrijver"]}, {"keys": ["tivoli", "sportcampus", "kovelswade"], "ans": "DIA Groep werkt aan projecten zoals <strong>TivoliVredenburg</strong> en het <strong>Kovelswade Rijksmonument</strong>.", "chips": ["Kennisbank"]}, {"keys": ["rapport", "rapportage"], "ans": "De <strong>Rapport Schrijver</strong> stelt exploitatieadviezen, installatieontwerpen en energieaudits op.", "chips": ["Rapport Schrijver"]}, {"keys": ["excel", "berekening"], "ans": "De <strong>Excel Assistent</strong> analyseert verbruikspatronen en berekent besparingspotenties per installatie-onderdeel.", "chips": ["Excel Assistent"]}, {"keys": ["norm", "nen", "bbl"], "ans": "De <strong>Norm Monitor</strong> houdt alle wijzigingen in Bbl, NEN en Paris Proof bij.", "chips": ["Norm Monitor"]}, {"keys": ["kennis", "archief", "zoek"], "ans": "De <strong>Kennisbank</strong> maakt uw projectarchief doorzoekbaar op gebouwtype en locatie.", "chips": ["Kennisbank"]}];
  var welcome="Goedemiddag! Ik ben de assistent van DIA Groep. Waarmee kan ik u helpen?";
